...
def main():
    ...
    # ===== SAMPLE SIZE LIMIT FOR TRAINING =====
    ...
    #print(f"[INFO] Training subset: {len(X_train.columns)} samples")
    ...
    print(f"[INFO] Test subset: {len(X_test)} samples")
